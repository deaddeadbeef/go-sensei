  ...
  useEffect(() => {
    ...
    if (phase === 'welcome' && !welcomeShown.current) {
      ...
      const welcomeMessages: Record<string, string> = {
        beginner: "I'm Go Sensei. Go is a 4,000-year-old strategy game — two players, black and white stones, one simple goal: surround more territory than your opponent. Stones go on intersections, not squares. Once placed, they don't move. You capture enemy stones by surrounding them completely. That's it — those are the rules. Everything else, you'll learn by doing.\n\nThis is a 19×19 board. You're Black, you move first. Click any intersection. I'll be direct when a move misses its purpose, and I'll always show the next repair so you know how to improve.",
        intermediate: "Go Sensei. 19×19 board. You're Black. I will assume you know the rules, then focus on shape, direction, and the priority behind each move.",
        advanced: "19×19. You're Black. I will keep the review concise: identify the point of the position, call out the highest-value mistake, and show the cleanest repair.",
