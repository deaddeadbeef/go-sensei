...
![Go Sensei](https://img.shields.io/badge/Model-GPT--5.4-blue) ![Next.js](https://img.shields.io/badge/Next.js-16-black) ![Tests](https://img.shields.io/badge/Tests-CI%20verified-green) ![License](https://img.shields.io/badge/License-MIT-yellow)
...
- 🧪 **CI-verified tests** — engine, lesson, problem, review, prompt, and state-management coverage
...
| Tests | Vitest | CI-verified unit and component coverage |
